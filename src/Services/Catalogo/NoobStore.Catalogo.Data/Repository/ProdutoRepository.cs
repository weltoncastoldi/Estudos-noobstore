...
namespace NoobStore.Catalogo.Data.Repository
{
    public class ProdutoRepository : IProdutoRepository
    {
        ...
        public async Task<IEnumerable<Produto>> ObterTodo()
        {
        ...
        {
            return await _context.Produtos.AsNoTracking().SingleOrDefaultAsync(p => p.Id == id);
        }
